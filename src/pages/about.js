  ...
  return (
    <div className='page about'>
      <Box title='Greetings! 👋🏻' imagePosition='none'>
        ...
        Having worked for four over years in corporations, startups and on individual projects, I developed the strength of understanding the technical, managerial and business-related aspects of a project. This is why is love offering my clients <i>complete solutions, from prototype to deployment, from sketch to final product</i>. <br /><br />
